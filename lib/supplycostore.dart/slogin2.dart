...
import 'package:stockit/packagesupplyco.dart';

class slogin2 extends StatefulWidget {
  const slogin2({super.key});

  @override
  State<slogin2> createState() => _slogin2State();
}

class _slogin2State extends State<slogin2> {
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>pacakagesupplyco(indexnum:0)));

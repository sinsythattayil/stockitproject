...
class supplycoowners extends StatefulWidget {
  const supplycoowners({super.key});

  @override
  State<supplycoowners> createState() => _supplycoownersState();
}

class _supplycoownersState extends State<supplycoowners> {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 50,),
                                      IconButton(onPressed: ()=>_showDeleteConfirmationDialog(context), icon: Icon(Icons.delete,size: 20,color: Colors.white,))
                                    ],
                                  ),
                                ),
                                
                                Text('Thachanpoyil(H)',style: GoogleFonts.abyssinicaSil(fontSize:18,color:Colors.white),),
                                Text('Pandikkad branch  ',style: GoogleFonts.abyssinicaSil(fontSize:16,color:Colors.white),),

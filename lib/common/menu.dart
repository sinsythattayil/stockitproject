  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(onPressed: (){}, icon: const Icon(Icons.arrow_back_ios_new)),//Icon(Icons.arrow_back_ios_sharp, size: 35,),
          actions: [
        ...
        children: [
          ...
          Visibility(
            ...
            child: Drawer(
                    child: ListView(
                    children: [
            const UserAccountsDrawerHeader(accountName: Text('ammu'), accountEmail: Text('ammu@gmail.com'),
            currentAccountPicture: CircleAvatar(),),
            const ListTile(
              leading: Icon(Icons.person),
              title: Text('profile'),

...
class mavorderview extends StatefulWidget {
  String orderId;
   mavorderview({super.key,required this.orderId});

  @override
  State<mavorderview> createState() => _mavorderviewState();
}

class _mavorderviewState extends State<mavorderview> {
  @override

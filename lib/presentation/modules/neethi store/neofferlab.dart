...
class neofferlab extends StatefulWidget {
  const neofferlab({super.key});

  @override
  State<neofferlab> createState() => _neofferlabState();
}

class _neofferlabState extends State<neofferlab> {
  @override
                ...
                child: Padding(
                  ...
                  return Padding(
                    ...
                    child:Column(children: [ 
                      SizedBox(height: 8,),
                       Text('Complete Heart Health Checkup',style: GoogleFonts.inknutAntiqua(fontSize:13,),),
                       SizedBox(height: 8,),
                        Row(

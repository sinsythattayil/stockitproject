...
class rationstoremenu extends StatefulWidget {
  const rationstoremenu({super.key});

  @override
  State<rationstoremenu> createState() => _rationstoremenuState();
}

class _rationstoremenuState extends State<rationstoremenu> {
  @override

...
class MaveliStockview extends StatefulWidget {
  String storeId;
   MaveliStockview({super.key,required this.storeId});

  @override
  State<MaveliStockview> createState() => _MaveliStockviewState();
}

class _MaveliStockviewState extends State<MaveliStockview> {
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  stream: DbController().getMaveliAndSupplycoAllProductForOrder('Maveli Products', widget.storeId),
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData) {
                      return list.isEmpty?Center(child: Text("No Stock",style: TextStyle(color: Colors.white),),): ListView.builder(
                                                      ...
                                                      style: const ButtonStyle(
                                                          ...
                                                          foregroundColor:
                                                              MaterialStatePropertyAll(
                                                                  Colors.white)),
                                                      onPressed: () {
                                                        controller.addToList(list[index]);
                                                      },
                                                      child:controller.choosedList.contains(list[index])? const Text(
                                                        'Remove',
                                                        style: TextStyle(
                                                          fontSize: 15,
                                                        ),
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(style: const ButtonStyle(backgroundColor: MaterialStatePropertyAll(Color.fromARGB(255, 227, 131, 52)),foregroundColor: MaterialStatePropertyAll(Colors.black)),
                         ...
                         if(Provider.of<Controller>(context,listen: false).choosedList.isEmpty){
                          Services.errorMessage(context, "Choose Item");
                         }else{
                          ...
                          storeProductModel:Provider.of<Controller>(context,listen: false).choosedList,

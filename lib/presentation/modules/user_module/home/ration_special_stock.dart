...
class RationSpecialStock extends StatefulWidget {
   String card;
  String storeId;
    String name;
  String cardNumber;
  String numberOfMembers;
   RationSpecialStock({super.key,required this.card,required this.storeId,required this.cardNumber,required this.numberOfMembers,required this.name});

  @override
  State<RationSpecialStock> createState() => _RationSpecialStockState();
}

class _RationSpecialStockState extends State<RationSpecialStock> {
            ...
            children: [
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  stream: DbController().getRationSpeciaProductDataForOrder(widget.storeId, widget.card),

...
class SupplycoStockView extends StatefulWidget {
  String storeId;
  SupplycoStockView({super.key, required this.storeId});

  @override
  State<SupplycoStockView> createState() => _SupplycoStockViewState();
}

class _SupplycoStockViewState extends State<SupplycoStockView> {
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  stream: DbController().getMaveliAndSupplycoAllProductForOrder(
                      'Supplyco Products', widget.storeId),
                      ...
                      if (Provider.of<Controller>(context, listen: false)
                        ...
                        DbController()
                            .addNewOrder(OrderModel(
                                ...
                                storeProductModel: Provider.of<Controller>(
                                        context,
                                        listen: false)
                                    .choosedList,

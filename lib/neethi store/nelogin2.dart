...
import 'package:stockit/packageneemodule.dart';
import 'package:stockit/packageration.dart';

class nelogin2 extends StatefulWidget {
  const nelogin2({super.key});

  @override
  State<nelogin2> createState() => _nelogin2State();
}

class _nelogin2State extends State<nelogin2> {
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>packageneemodule(indexnum: 0)));
